...
class Navigation {
  ...
  static Future<dynamic> pushNamedAuthorized(String routeName,
    ...
    return Navigator.of(appContext, rootNavigator: rootNavigator)
        .pushNamed(routeName, arguments: arguments);
  }
  ...
  static pushNamedAndRemoveUntil(String routeName,
      ...
      Navigator.of(appContext, rootNavigator: rootNavigator)
          .pushNamedAndRemoveUntil(routeName, (route) => false,
              arguments: arguments);
  static pop({var params, bool rootNavigator = false, int delay = 0}) => Timer(
      Duration(milliseconds: delay),
      () => Navigator.of(appContext, rootNavigator: rootNavigator).pop(params));
