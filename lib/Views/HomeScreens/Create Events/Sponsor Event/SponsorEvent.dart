...
class SponsorEvent extends StatefulWidget {
  ...
  @override
  State<SponsorEvent> createState() => _SponsorEventState();
}

class _SponsorEventState extends State<SponsorEvent> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBarCustom(title: "Sponsor Event"),
